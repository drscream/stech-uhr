...
urlpatterns = patterns('',
		...
		url(r'^user/settings/job/$', views.user_settings_job,
			name='user_settings_job'),
		url(r'^user/settings/job/(?P<job_id>\d+)',
			views.user_settings_job_details,
			name='view.user_settings_job_details'),
		# reports
